...
class LLMAgentFactory:
    ...
    def create_agent(self, provider: str) -> GoogleLLMClient | GroqLLMClient | HuggingfaceLLMClient:
        """
        ...
        Returns:
            the corresponding client or None if the given provider name is invalid
        """
